%% ECE 620 - Project - Team 1
%% Understanding cascading failures in Internet of Things
%% Team Members:
%% Vikram Vijayakumar
%% Shaqueir Tardif
%% References to Code:
...
%Main 
sensor.nodes = 50; %Number of nodes
...
sensor.energyconsumptionperCicle = 0.35;
...
grid on
hold on
title(['Smart Home IOT System (WSN) | ','Number of Sensor Nodes: ',num2str(sensor.nodes),' | Range of each Sensor Node: ', num2str(sensor.range)])
pause(2)
